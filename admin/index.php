          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-bottom-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row">
                    <div class="font-weight-bold text-success text-uppercase">Scheduling</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <!-- Color System -->
              <div class="row">
                <div class="col-lg-3 mb-4 "><a href="trips.php">
                  <div class="card bg-primary schedule text-white shadow">
                    <div class="card-body">
                      Schedule Trips
