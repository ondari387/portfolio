        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="text-primary font-weight-bold">Michael Ondari</p>
                    <p class="text-muted">Posted on 24TH NOVEMBER,2020 at 12.45am</p>
                    <img src="img/background/tech1.jpg" class="w-100 pb-3" alt="">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, unde voluptatem. Repudiandae vel
                        iusto corrupti. Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, eius ratione
                        fugiat cum laboriosam aliquam quis ipsam officia cumque voluptatum voluptates veritatis esse
                        earum ex?</p>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form mb-4">
                            ...
                            <a type="submit" name="contact_message" class="btn btn-primary text-white font-weight-bold">Submit</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="about-author">
                        ...
                        <div class="about-the-author text-center p-3" style="border: 0.5px solid #e9ecef;border-radius: 10px;" <img src="img/background/tech2.jpg" class="rounded-circle" width="200px" height="200px" alt="">
                            ...
                            <div class="author-profile">
                                <p class="text-primary">Author's Name</p>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, doloremque harum?
                                    Eaque
                                    officiis, dolorem tenetur accusantium labore dolores harum hic?</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="containers">
                            ...
                            <div class="newsletter pt-3 p-3 mt-4" style="border: 0.5px solid #e9ecef;border-radius: 10px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <a type="submit" name="contact_message" class="btn btn-primary text-white font-weight-bold">Subscribe</a>
                                </div>
                            </div>
                        </div>
                    </div>
